...
<div>
## React, Electron, Kiosk Specialist
I have rich experience in react, electron, native mobile and hybrid mobile solution such as electron kiosk projects with react and bluetooth beacon applications for mobile.
My team and I excels in <b>Kiosk Software for Windows, Android , Chrome OS </b> and main skills are C++, MYSQL, React, Javascript, Laravel, PHP, Go, Rust, Ruby on Rails, etc.
